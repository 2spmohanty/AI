...
from tools_manifest import ANTHROPIC_TOOLS_MANIFEST, ANTHROPIC_TOOLS_WITHOUT_VECTOR_MANIFEST
...
def run_v3_react_agent(raw_log: str, max_turns: int = 5) -> dict:
    ...
    print("Launching v3 Native Anthropic Tool Execution Pipeline with MCP support...")
    ...
    for turn in range(max_turns):
        ...
        response = client.beta.messages.create(
            ...
            tools=ANTHROPIC_TOOLS_WITHOUT_VECTOR_MANIFEST,
            mcp_servers=[
                {
                    "type": "url",
